      ...
      <nav className="nav">
        <div>
          ...
          <div className="nav_list">
            ...
            <a href="#" className="nav_link">
              {" "}
              <i className="bx bx-message-square-detail nav_icon"></i> <span className="nav_name">Messages</span>{" "}
            </a>{" "}
            <a href="#" className="nav_link">
              {" "}
              <i className="bx bx-bookmark nav_icon"></i> <span className="nav_name">Bookmark</span>{" "}
            </a>{" "}
            <a href="#" className="nav_link">
              {" "}
              <i className="bx bx-folder nav_icon"></i> <span className="nav_name">Files</span>{" "}
            </a>{" "}
            <a href="#" className="nav_link">
              {" "}
